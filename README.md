...
2. Clone this repository: `git clonehttps://github.com/gorkawien/AturuxOS-Plasma-Testing`
3. Run the script: `cd Aturux-OS-Plasma-Testing/ && chmod +x setup && ./setup`
...
* Desktop Environments
  ...
  * Cinnamon
  * GNOME
  * KDE Plasma (with extra software)
  * LXDE
  * LXQT
  * MATE
  * Xfce
